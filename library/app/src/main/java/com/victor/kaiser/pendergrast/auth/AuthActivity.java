...
import com.victor.kaiser.pendergrast.auth.setup.DeviceCodeJsonParser;
import com.victor.kaiser.pendergrast.auth.setup.GetAuthTokenTask;
import com.victor.kaiser.pendergrast.auth.setup.GetDeviceCodeTask;
import com.victor.kaiser.pendergrast.auth.setup.GetDeviceCodeTask.OnGetDeviceCodeListener;
...
public class AuthActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// The screen will likely try to timeout;
		// This whole setup Activity will likely take a few minutes to complete
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER) {
			// On touchpad tap, determine what to do based on the current state
			switch (mState) {
			case STATE_START:
				// After "tap to begin"
				// Get the device code
	...
	/**
	 * Set the UI to display a "Loading..." message
	 */
	...
	/**
	 * Set the UI to display a "Testing code" message
	 */
	...
	/**
	 * Indicate a failure, and that tapping will restart
	...
	/**
	 * Set the UI to indicate that auth was successful
	 */
	...
	/**
	 * Display a user code and url retrieved from Google
	 */
